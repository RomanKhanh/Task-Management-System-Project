...
export const Layout = () => {
  const { currentUser, logout, notifications, markNotificationRead } = useAppContext();
                    ...
                    <div className="max-h-[400px] overflow-y-auto">
                      {userNotifications.length === 0 ? (
                        ...
                        userNotifications.map(n => (
                          ...
                          >
                            <p className={cn("text-sm leading-snug", !n.read ? "font-semibold text-slate-900" : "text-slate-600")}>
                              {n.message}
                            </p>

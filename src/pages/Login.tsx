...
export const Login = () => {
  const { users, login, register, resetData, setCurrentUser } = useAppContext();
...
//     const user = await userService.loginUser(loginEmail, loginPassword);
...
const handleRegister = async (e: React.FormEvent) => {
  ...
  // 👇 tạo ở đây, trên function Register()
